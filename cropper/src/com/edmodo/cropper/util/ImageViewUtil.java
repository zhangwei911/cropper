...
public class ImageViewUtil {
    ...
    /**
     * Gets the rectangular position of a Bitmap if it were placed inside a View with scale type set
    ...
    /**
     * Helper that does the work of the above functions. Gets the rectangular position of a Bitmap
     * if it were placed inside a View with scale type set to {@link android.widget.ImageView.ScaleType#CENTER_INSIDE}.
     *
     * @param bitmapWidth  the Bitmap's width
     * @param bitmapHeight the Bitmap's height
     * @param viewWidth    the parent View's width
